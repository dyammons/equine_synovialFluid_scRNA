...
### Extract data to confirm that there are more myeloid-myeloid interaction than myeloid-lymphoid or lymphoid-lymphoid
...
# NOTE: this block needs to be iterated through manually
...
#manually clean the figures - Normal
